...
namespace HslCommunication.BasicFramework
{
	...
	public class SoftFileSaveBase : ISoftFileSaveBase
	{
		...
		/// <inheritdoc cref="ISoftFileSaveBase.ToSaveString"/>
		public virtual string ToSaveString( ) => string.Empty;

		/// <inheritdoc cref="ISoftFileSaveBase.LoadByString(string)"/>
		...
		/// <inheritdoc cref="ISoftFileSaveBase.LoadByFile"/>
		...
		/// <inheritdoc cref="ISoftFileSaveBase.SaveToFile"/>

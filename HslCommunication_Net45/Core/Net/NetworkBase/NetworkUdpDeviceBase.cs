...
namespace HslCommunication.Core.Net
{
	...
	/// Udp报文协议的内容传送
	/// </summary>
	public class NetworkUdpDeviceBase : NetworkUdpBase, IReadWriteDevice
	{
		#region Constructor
		...
		/// <inheritdoc/>
		public override string ToString( ) => $"NetworkUdpDeviceBase<{ByteTransform.GetType( )}>[{IpAddress}:{Port}]";

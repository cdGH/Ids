...
namespace HslCommunication.Core.Net
{
	...
	/// 一个基于WebApi协议的设备类对象
	/// </summary>
	public class NetworkWebApiDevice : NetworkWebApiBase, IReadWriteNet
	{
		/// <summary>
		/// 实例化一个默认的对象，使用127.0.0.1和端口80
		/// </summary>
		public NetworkWebApiDevice( ) : base( "127.0.0.1", 80 )
		{
		...
		public NetworkWebApiDevice( string ipAddress, int port = 80 ) : base( ipAddress, port )
		{
		...
		/// <inheritdoc/>
		public override string ToString( ) => $"NetworkWebApiDevice[{IpAddress}:{Port}]";
